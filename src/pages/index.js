...
export default function Home() {
	...
	async function createCategory() {
		let res = await fetch("http://localhost:3000/api/categories/create", {
			method: "POST",
			body: JSON.stringify({
	...
	async function getCategories() {
		let data = [];
		let res = await fetch("http://localhost:3000/api/categories/read", {
			method: "GET"
		});
		res = await res.json();
	...
	async function createCredential() {
		let res = await fetch("http://localhost:3000/api/credentials/create", {
			method: "POST",
			body: JSON.stringify({
	...
	async function getCredentials(id) {
		...
		let res = await fetch("http://localhost:3000/api/credentials/read?"+params, {
			method: "GET"
		});
		res = await res.json();
	...
	async function deleteCredential(id){
		let res = await fetch("http://localhost:3000/api/credentials/delete?id="+id, {
			method: "DELETE"
		});
		res = await res.json();
